...
;debug.h,14 :: 		debugText = "1";
	MOVLW       ?lstr3_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr3_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,18 :: 		debugText = "0";
	MOVLW       ?lstr4_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr4_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,23 :: 		debugText = "1";
	MOVLW       ?lstr5_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr5_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,27 :: 		debugText = "0";
	MOVLW       ?lstr6_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr6_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,32 :: 		debugText = "1";
	MOVLW       ?lstr7_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr7_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,36 :: 		debugText = "0";
	MOVLW       ?lstr8_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr8_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,41 :: 		debugText = "1";
	MOVLW       ?lstr9_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr9_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,45 :: 		debugText = "0";
	MOVLW       ?lstr10_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr10_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,50 :: 		debugText = "1";
	MOVLW       ?lstr11_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr11_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,54 :: 		debugText = "0";
	MOVLW       ?lstr12_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr12_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,59 :: 		debugText = "1";
	MOVLW       ?lstr13_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr13_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,63 :: 		debugText = "0";
	MOVLW       ?lstr14_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr14_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,68 :: 		debugText = "1";
	MOVLW       ?lstr15_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr15_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,72 :: 		debugText = "0";
	MOVLW       ?lstr16_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr16_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,77 :: 		debugText = "1";
	MOVLW       ?lstr17_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr17_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,81 :: 		debugText = "0";
	MOVLW       ?lstr18_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr18_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,86 :: 		debugText = "1";
	MOVLW       ?lstr19_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr19_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,90 :: 		debugText = "0";
	MOVLW       ?lstr20_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr20_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,95 :: 		debugText = " 1; ";
	MOVLW       ?lstr21_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr21_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,99 :: 		debugText = " 0; ";
	MOVLW       ?lstr22_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr22_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,106 :: 		debugText = "move Forward  ";
	MOVLW       ?lstr23_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr23_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,111 :: 		debugText = "turn Left";
	MOVLW       ?lstr24_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr24_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,117 :: 		debugText = "turn Right";
	MOVLW       ?lstr25_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr25_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,123 :: 		debugText = "Stopping..   ";
	MOVLW       ?lstr26_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr26_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;debug.h,126 :: 		debugText = "Decrease PWM..   ";
	MOVLW       ?lstr27_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr27_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;linefollow.h,19 :: 		debugText = "Line follow PID..   ";
	MOVLW       ?lstr28_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr28_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;linefollow.h,26 :: 		debugText = "Line follow Normal..   ";
	MOVLW       ?lstr29_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr29_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;linefollow.h,45 :: 		else if( (Scout==0 && Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1) || (Scout==0 && Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1)){
	...
	BTFSS       PORTB+0, 7 
	GOTO        L__lineFollowNormal200
	GOTO        L__lineFollowNormal198
L__lineFollowNormal200:
	BTFSC       PORTB+0, 5 
	GOTO        L__lineFollowNormal199
	BTFSC       PORTB+0, 4 
	GOTO        L__lineFollowNormal199
	BTFSC       PORTB+0, 3 
	GOTO        L__lineFollowNormal199
...
;linefollow.h,47 :: 		debugText = "90 to right..   ";
	MOVLW       ?lstr30_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr30_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;linefollow.h,56 :: 		debugText = "90 to left..   ";
	MOVLW       ?lstr31_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr31_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;linefollow.h,134 :: 		if( (Scout==0 && Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1) || (Scout==0 && Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1)){
	...
	BTFSS       PORTB+0, 7 
	GOTO        L__lineFollowPID219
	GOTO        L__lineFollowPID217
L__lineFollowPID219:
	BTFSC       PORTB+0, 5 
	GOTO        L__lineFollowPID218
	BTFSC       PORTB+0, 4 
	GOTO        L__lineFollowPID218
	BTFSC       PORTB+0, 3 
	GOTO        L__lineFollowPID218
...
;linefollow.h,136 :: 		debugText = "90 to right..   ";
	MOVLW       ?lstr32_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr32_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;linefollow.h,145 :: 		debugText = "90 to left..   ";
	MOVLW       ?lstr33_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr33_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;Main 1.2V.c,15 :: 		debugText = "          Starting..  ";
	MOVLW       ?lstr34_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr34_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;Main 1.2V.c,19 :: 		debugText = "Test Sensors   ";
	MOVLW       ?lstr35_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr35_Main_321.2V+0)
	MOVWF       _debugText+1 
...
;Main 1.2V.c,28 :: 		debugText = "Start Line follow..   ";
	MOVLW       ?lstr36_Main_321.2V+0
	MOVWF       _debugText+0 
	MOVLW       hi_addr(?lstr36_Main_321.2V+0)
	MOVWF       _debugText+1 
