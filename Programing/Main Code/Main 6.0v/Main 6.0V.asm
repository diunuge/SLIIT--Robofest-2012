...
;linefollow.h,261 :: 		if(((Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==0 && Sensor7==0) || ( Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==0) || ( Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==0 && Sensor7==0) || ( Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==1 && Sensor7==0)) && Sensor1==0 && Sensor2==0 && Sensor8==0 && Sensor9==0)
	...
	BTFSC       PORTB+0, 2 
	GOTO        L__isOnThePath826
	GOTO        L__isOnThePath822
L__isOnThePath826:
	BTFSC       PORTD+0, 4 
	GOTO        L__isOnThePath825
	BTFSS       PORTD+0, 5 
	GOTO        L__isOnThePath825
	BTFSS       PORTD+0, 6 
	GOTO        L__isOnThePath825
...
;linefollow.h,298 :: 		else if( (Scout==0 && Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1) || (Scout==0 && Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1)){
	...
	BTFSS       PORTB+0, 7 
	GOTO        L__lineFollowNormal843
	GOTO        L__lineFollowNormal841
L__lineFollowNormal843:
	BTFSC       PORTB+0, 5 
	GOTO        L__lineFollowNormal842
	BTFSC       PORTB+0, 4 
	GOTO        L__lineFollowNormal842
	BTFSC       PORTB+0, 3 
	GOTO        L__lineFollowNormal842
...
;linefollow.h,368 :: 		if( Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==0 && Sensor7==0)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast382
	BTFSS       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast382
	BTFSS       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast382
...
;linefollow.h,370 :: 		else if( Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==0)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast386
	BTFSS       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast386
	BTFSS       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast386
...
;linefollow.h,372 :: 		else if( Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==0 && Sensor7==0)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast390
	BTFSC       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast390
	BTFSS       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast390
...
;linefollow.h,374 :: 		else if( Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==1 && Sensor7==0)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast394
	BTFSC       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast394
	BTFSS       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast394
...
;linefollow.h,380 :: 		else if( Sensor3==1 && Sensor4==0 && Sensor5==0 && Sensor6==0 && Sensor7==0)
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast398
	BTFSC       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast398
	BTFSC       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast398
...
;linefollow.h,383 :: 		else if( Sensor3==1 && Sensor4==1 && Sensor5==0 && Sensor6==0 && Sensor7==0)
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast402
	BTFSS       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast402
	BTFSC       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast402
...
;linefollow.h,386 :: 		else if( Sensor3==1 && Sensor4==1 && Sensor5==1 && Sensor6==0 && Sensor7==0)
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast406
	BTFSS       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast406
	BTFSS       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast406
...
;linefollow.h,389 :: 		else if( Sensor3==0 && Sensor4==1 && Sensor5==0 && Sensor6==0 && Sensor7==0)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast410
	BTFSS       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast410
	BTFSC       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast410
...
;linefollow.h,394 :: 		else if( Sensor3==0 && Sensor4==0 && Sensor5==0 && Sensor6==1 && Sensor7==0)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast414
	BTFSC       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast414
	BTFSC       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast414
...
;linefollow.h,399 :: 		turnRight(FAST_PWM);
	...
	MOVWF       FARG_turnRight_pwmLeft+1 
	CALL        _turnRight+0, 0
	GOTO        L_lineFollowNormalWorkedForLast419
...
;linefollow.h,403 :: 		else if( Sensor3==0 && Sensor4==0 && Sensor5==0 && Sensor6==0 && Sensor7==1)
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast426
	BTFSC       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast426
	BTFSC       PORTD+0, 6 
	GOTO        L_lineFollowNormalWorkedForLast426
...
;linefollow.h,409 :: 		moveForward(FAST_PWM,FAST_PWM);
	...
	MOVWF       FARG_moveForward_pwmRight+1 
	CALL        _moveForward+0, 0
	GOTO        L_lineFollowNormalWorkedForLast431
...
;linefollow.h,411 :: 		moveForward(FAST_PWM,FAST_PWM);
	...
	MOVWF       FARG_moveForward_pwmRight+1 
	CALL        _moveForward+0, 0
	GOTO        L_lineFollowNormalWorkedForLast435
...
;linefollow.h,413 :: 		moveForward(255,255);
	...
	MOVWF       FARG_moveForward_pwmRight+1 
	CALL        _moveForward+0, 0
	GOTO        L_lineFollowNormalWorkedForLast439
...
;linefollow.h,415 :: 		else if(isAllBlack()){
	...
	IORWF       R1, 0 
	BTFSC       STATUS+0, 2 
	GOTO        L_lineFollowNormalWorkedForLast440
...
;linefollow.h,435 :: 		else if( Sensor1==1 && Sensor2==1 && Sensor3==1 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==0 && Sensor8==0 && Sensor9==0)
	BTFSS       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast449
	BTFSS       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast449
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast449
...
;linefollow.h,436 :: 		rotateByDegree(-90);
	...
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
	GOTO        L_lineFollowNormalWorkedForLast450
...
;linefollow.h,437 :: 		else if( Sensor1==1 && Sensor2==1 && Sensor3==1 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==0 && Sensor9==0)
	BTFSS       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast453
	BTFSS       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast453
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast453
...
;linefollow.h,438 :: 		rotateByDegree(-90);
	...
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
	GOTO        L_lineFollowNormalWorkedForLast454
...
;linefollow.h,441 :: 		else if( Sensor1==0 && Sensor2==0 && Sensor3==1 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1)
	BTFSC       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast457
	BTFSC       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast457
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast457
...
;linefollow.h,442 :: 		rotateByDegree(90);
	...
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
	GOTO        L_lineFollowNormalWorkedForLast458
...
;linefollow.h,443 :: 		else if( Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==1 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1)
	BTFSC       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast461
	BTFSC       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast461
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast461
...
;linefollow.h,444 :: 		rotateByDegree(90);
	...
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
	GOTO        L_lineFollowNormalWorkedForLast462
...
;linefollow.h,445 :: 		else if( Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==0 && Sensor5==1 && Sensor6==1 && Sensor7==1 && Sensor8==1 && Sensor9==1)
	BTFSC       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast465
	BTFSC       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast465
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast465
...
;linefollow.h,482 :: 		moveForward(FAST_PWM,SLOW_PWM);
	...
	MOVWF       FARG_moveForward_pwmRight+1 
	CALL        _moveForward+0, 0
	GOTO        L_lineFollowNormalWorkedForLast506
...
;linefollow.h,483 :: 		else if( Sensor2==1 && Sensor3==1 && Sensor4==1 && Sensor5==0 && Sensor6==1 && Sensor7==1 && Sensor8==1)
	BTFSS       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast509
	BTFSS       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast509
	BTFSS       PORTD+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast509
...
L_lineFollowNormalWorkedForLast510:
	BTFSC       PORTB+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast511
;linefollow.h,485 :: 		rotateAntiClockwise(255);
	...
	MOVWF       FARG_rotateAntiClockwise_pwm+1 
	CALL        _rotateAntiClockwise+0, 0
	GOTO        L_lineFollowNormalWorkedForLast510
L_lineFollowNormalWorkedForLast511:
	GOTO        L_lineFollowNormalWorkedForLast512
...
;linefollow.h,486 :: 		else if( Sensor1==0 && Sensor2==0 && Sensor3==0 && Sensor4==0 && Sensor5==0 && Sensor6==0 && Sensor7==0 && Sensor8==1 && Sensor9==1)
	BTFSC       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast515
	BTFSC       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast515
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast515
...
L_lineFollowNormalWorkedForLast516:
	BTFSC       PORTB+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast517
;linefollow.h,488 :: 		rotateClockwise(255);
	...
	MOVWF       FARG_rotateClockwise_pwm+1 
	CALL        _rotateClockwise+0, 0
	GOTO        L_lineFollowNormalWorkedForLast516
L_lineFollowNormalWorkedForLast517:
	GOTO        L_lineFollowNormalWorkedForLast518
...
;linefollow.h,489 :: 		else if( Sensor1==1 && Sensor2==1 && Sensor3==0 && Sensor4==0 && Sensor5==0 && Sensor6==0 && Sensor7==0 && Sensor8==0 && Sensor9==0)
	BTFSS       PORTB+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast521
	BTFSS       PORTB+0, 3 
	GOTO        L_lineFollowNormalWorkedForLast521
	BTFSC       PORTD+0, 4 
	GOTO        L_lineFollowNormalWorkedForLast521
...
L_lineFollowNormalWorkedForLast522:
	BTFSC       PORTB+0, 5 
	GOTO        L_lineFollowNormalWorkedForLast523
...
;linefollow.h,501 :: 		moveForward(FAST_PWM,SLOW_PWM);
	...
	MOVWF       FARG_moveForward_pwmRight+1 
	CALL        _moveForward+0, 0
	GOTO        L_lineFollowNormalWorkedForLast540
...
;linefollow.h,504 :: 		else if(isAllWhite()){
	...
	IORWF       R1, 0 
	BTFSC       STATUS+0, 2 
	GOTO        L_lineFollowNormalWorkedForLast541
;linefollow.h,507 :: 		sendSensorStatus();
	CALL        _sendSensorStatus+0, 0
;linefollow.h,508 :: 		}
	GOTO        L_lineFollowNormalWorkedForLast542
...
;ir.h,24 :: 		if( 610<=ir_value && ir_value<623)         //3cm - 3.75cm
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120925
	MOVLW       98
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120925:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120926
	MOVLW       111
	SUBWF       _ir_value+0, 0 
...
;ir.h,27 :: 		else if( 557<=ir_value && ir_value<610 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120927
	MOVLW       45
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120927:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120928
	MOVLW       98
	SUBWF       _ir_value+0, 0 
...
;ir.h,30 :: 		else if( 481<=ir_value && ir_value<557 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120929
	MOVLW       225
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120929:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120930
	MOVLW       45
	SUBWF       _ir_value+0, 0 
...
;ir.h,33 :: 		else if( 409<=ir_value && ir_value<481 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120931
	MOVLW       153
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120931:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120932
	MOVLW       225
	SUBWF       _ir_value+0, 0 
...
;ir.h,36 :: 		else if( 364<=ir_value && ir_value<409 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120933
	MOVLW       108
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120933:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120934
	MOVLW       153
	SUBWF       _ir_value+0, 0 
...
;ir.h,39 :: 		else if( 317<=ir_value && ir_value<364 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120935
	MOVLW       61
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120935:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120936
	MOVLW       108
	SUBWF       _ir_value+0, 0 
...
;ir.h,42 :: 		else if( 286<=ir_value && ir_value<317 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120937
	MOVLW       30
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120937:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120938
	MOVLW       61
	SUBWF       _ir_value+0, 0 
...
;ir.h,45 :: 		else if( 256<=ir_value && ir_value<286 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120939
	MOVLW       0
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120939:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120940
	MOVLW       30
	SUBWF       _ir_value+0, 0 
...
;ir.h,48 :: 		else if( 215<=ir_value && ir_value<256 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120941
	MOVLW       215
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120941:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120942
	MOVLW       0
	SUBWF       _ir_value+0, 0 
...
;ir.h,51 :: 		else if( 186<=ir_value && ir_value<215 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120943
	MOVLW       186
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120943:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120944
	MOVLW       215
	SUBWF       _ir_value+0, 0 
...
;ir.h,54 :: 		else if( 166<=ir_value && ir_value<186 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120945
	MOVLW       166
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120945:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120946
	MOVLW       186
	SUBWF       _ir_value+0, 0 
...
;ir.h,57 :: 		else if( 147<=ir_value && ir_value<166 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120947
	MOVLW       147
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120947:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120948
	MOVLW       166
	SUBWF       _ir_value+0, 0 
...
;ir.h,60 :: 		else if( 133<=ir_value && ir_value<147 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120949
	MOVLW       133
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120949:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120950
	MOVLW       147
	SUBWF       _ir_value+0, 0 
...
;ir.h,63 :: 		else if( 106<=ir_value && ir_value<133 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120951
	MOVLW       106
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120951:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120952
	MOVLW       133
	SUBWF       _ir_value+0, 0 
...
;ir.h,66 :: 		else if( 88<=ir_value && ir_value<106 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120953
	MOVLW       88
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120953:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120954
	MOVLW       106
	SUBWF       _ir_value+0, 0 
...
;ir.h,69 :: 		else if( 78<=ir_value && ir_value<88 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120955
	MOVLW       78
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120955:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120956
	MOVLW       88
	SUBWF       _ir_value+0, 0 
...
;ir.h,72 :: 		else if( 65<=ir_value && ir_value<78 )
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120957
	MOVLW       65
	SUBWF       _ir_value+0, 0 
L__getDistanceIR_GP2D120957:
	...
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceIR_GP2D120958
	MOVLW       78
	SUBWF       _ir_value+0, 0 
...
L_getSonarDistance619:
	BTFSC       PORTE+0, 0 
	GOTO        L_getSonarDistance620
	GOTO        L_getSonarDistance619
...
L_getSonarDistance621:
	BTFSS       PORTE+0, 0 
	GOTO        L_getSonarDistance622
;sonar.h,25 :: 		_counter++;
	INFSNZ      __counter+0, 1 
	INCF        __counter+1, 1 
;sonar.h,26 :: 		}
	GOTO        L_getSonarDistance621
...
;sonar.h,50 :: 		if(H>0xF0)
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceSonar2959
	MOVF        getDistanceSonar2_H_L0+0, 0 
	SUBLW       240
L__getDistanceSonar2959:
	BTFSC       STATUS+0, 0 
	GOTO        L_getDistanceSonar2628
;sonar.h,51 :: 		break;
	GOTO        L_getDistanceSonar2627
L_getDistanceSonar2628:
;sonar.h,52 :: 		}
	GOTO        L_getDistanceSonar2626
...
;sonar.h,60 :: 		if(H>0xF0)
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceSonar2960
	MOVF        getDistanceSonar2_H_L0+0, 0 
	SUBLW       240
L__getDistanceSonar2960:
	BTFSC       STATUS+0, 0 
	GOTO        L_getDistanceSonar2631
;sonar.h,61 :: 		break;
	GOTO        L_getDistanceSonar2630
L_getDistanceSonar2631:
;sonar.h,62 :: 		}
	GOTO        L_getDistanceSonar2629
...
;sonar.h,90 :: 		if(H>0xF0)
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceSonar2962
	MOVF        getDistanceSonar2_H_L0+0, 0 
	SUBLW       240
L__getDistanceSonar2962:
	BTFSC       STATUS+0, 0 
	GOTO        L_getDistanceSonar2641
;sonar.h,91 :: 		break;
	GOTO        L_getDistanceSonar2640
...
;sonar.h,120 :: 		if(H>0xF0)
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__getDistanceSonar2964
	MOVF        getDistanceSonar2_H_L0+0, 0 
	SUBLW       240
L__getDistanceSonar2964:
	BTFSC       STATUS+0, 0 
	GOTO        L_getDistanceSonar2651
;sonar.h,121 :: 		break;
	GOTO        L_getDistanceSonar2650
...
L_level3Aligning652:
	BTFSS       PORTD+0, 5 
	GOTO        L__level3Aligning901
	BTFSS       PORTD+0, 6 
	GOTO        L__level3Aligning901
	BTFSS       PORTD+0, 7 
	GOTO        L__level3Aligning901
	GOTO        L_level3Aligning653
...
L_level3Aligning658:
	...
	BTFSS       PORTB+0, 7 
	GOTO        L__level3Aligning900
	GOTO        L_level3Aligning659
L__level3Aligning900:
;Main 6.0V.c,33 :: 		if(Sensor9 == 1)
	BTFSS       PORTB+0, 7 
	GOTO        L_level3Aligning662
;Main 6.0V.c,34 :: 		rotateAntiClockwise(220);
	...
	MOVWF       FARG_rotateAntiClockwise_pwm+1 
	CALL        _rotateAntiClockwise+0, 0
	GOTO        L_level3Aligning663
L_level3Aligning662:
;Main 6.0V.c,36 :: 		else if(Sensor1 == 1)
	BTFSS       PORTB+0, 4 
	GOTO        L_level3Aligning664
...
L_level2Aligning665:
	...
	BTFSS       PORTD+0, 7 
	GOTO        L__level2Aligning905
	GOTO        L_level2Aligning666
L__level2Aligning905:
	BTFSS       PORTD+0, 5 
	GOTO        L__level2Aligning904
	BTFSS       PORTD+0, 6 
	GOTO        L__level2Aligning904
	BTFSS       PORTD+0, 7 
	GOTO        L__level2Aligning904
...
L_level2Aligning675:
	...
	BTFSS       PORTB+0, 7 
	GOTO        L__level2Aligning902
	GOTO        L_level2Aligning676
L__level2Aligning902:
;Main 6.0V.c,51 :: 		if(Sensor9 == 1)
	BTFSS       PORTB+0, 7 
	GOTO        L_level2Aligning679
;Main 6.0V.c,52 :: 		rotateClockwise(220);
	...
	MOVWF       FARG_rotateClockwise_pwm+1 
	CALL        _rotateClockwise+0, 0
	GOTO        L_level2Aligning680
L_level2Aligning679:
;Main 6.0V.c,54 :: 		else if(Sensor1 == 1)
	BTFSS       PORTB+0, 4 
	GOTO        L_level2Aligning681
...
;Main 6.0V.c,159 :: 		int isRightSafe(){
;Main 6.0V.c,160 :: 		ir_value = ADC_Read(IRSensorRight);
	MOVLW       0
	BTFSC       PORTA+0, 1 
	MOVLW       1
	MOVWF       FARG_ADC_Read_channel+0 
	...
	MOVF        R1, 0 
	MOVWF       _ir_value+1 
;Main 6.0V.c,161 :: 		if(250<=ir_value && ir_value<800){                         // ~5cm
	MOVLW       0
	SUBWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__isRightSafe966
	MOVLW       250
	SUBWF       R0, 0 
L__isRightSafe966:
	BTFSS       STATUS+0, 0 
	GOTO        L_isRightSafe718
	MOVLW       3
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__isRightSafe967
	MOVLW       32
	SUBWF       _ir_value+0, 0 
L__isRightSafe967:
	BTFSC       STATUS+0, 0 
	GOTO        L_isRightSafe718
L__isRightSafe910:
;Main 6.0V.c,162 :: 		return FALSE;
	CLRF        R0 
	CLRF        R1 
	RETURN      0
;Main 6.0V.c,163 :: 		}
L_isRightSafe718:
;Main 6.0V.c,164 :: 		return TRUE;
	MOVLW       1
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;Main 6.0V.c,167 :: 		int isMiddleSafe(){
;Main 6.0V.c,168 :: 		ir_value = ADC_Read(IRSensorCenter);
	MOVLW       0
	BTFSC       PORTA+0, 0 
	MOVLW       1
	MOVWF       FARG_ADC_Read_channel+0 
	...
	MOVF        R1, 0 
	MOVWF       _ir_value+1 
;Main 6.0V.c,169 :: 		if(250<=ir_value && ir_value<800){                         // ~5cm
	MOVLW       0
	SUBWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__isMiddleSafe968
	MOVLW       250
	SUBWF       R0, 0 
L__isMiddleSafe968:
	BTFSS       STATUS+0, 0 
	GOTO        L_isMiddleSafe721
	MOVLW       3
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__isMiddleSafe969
	MOVLW       32
	SUBWF       _ir_value+0, 0 
L__isMiddleSafe969:
	BTFSC       STATUS+0, 0 
	GOTO        L_isMiddleSafe721
L__isMiddleSafe911:
;Main 6.0V.c,170 :: 		return FALSE;
	CLRF        R0 
	CLRF        R1 
	RETURN      0
;Main 6.0V.c,171 :: 		}
L_isMiddleSafe721:
;Main 6.0V.c,172 :: 		return TRUE;
	MOVLW       1
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;Main 6.0V.c,175 :: 		int isLeftSafe(){
;Main 6.0V.c,176 :: 		ir_value = ADC_Read(IRSensorLeft);
	MOVLW       0
	BTFSC       PORTA+0, 2 
	MOVLW       1
	MOVWF       FARG_ADC_Read_channel+0 
	...
	MOVF        R1, 0 
	MOVWF       _ir_value+1 
;Main 6.0V.c,177 :: 		if(250<=ir_value && ir_value<800){                         // ~5cm
	MOVLW       0
	SUBWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__isLeftSafe970
	MOVLW       250
	SUBWF       R0, 0 
L__isLeftSafe970:
	BTFSS       STATUS+0, 0 
	GOTO        L_isLeftSafe724
	MOVLW       3
	SUBWF       _ir_value+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__isLeftSafe971
	MOVLW       32
	SUBWF       _ir_value+0, 0 
L__isLeftSafe971:
	BTFSC       STATUS+0, 0 
	GOTO        L_isLeftSafe724
L__isLeftSafe912:
;Main 6.0V.c,178 :: 		return FALSE;
	CLRF        R0 
	CLRF        R1 
	RETURN      0
;Main 6.0V.c,179 :: 		}
L_isLeftSafe724:
;Main 6.0V.c,180 :: 		return TRUE;
	MOVLW       1
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;Main 6.0V.c,187 :: 		void moveStraightFast(){
;Main 6.0V.c,188 :: 		moveForward(255,250);
	MOVLW       255
	MOVWF       FARG_moveForward_pwmLeft+0 
	MOVLW       0
	MOVWF       FARG_moveForward_pwmLeft+1 
...
;Main 6.0V.c,191 :: 		void goThroughObstaclesWorking(){
;Main 6.0V.c,192 :: 		ROTATION_ANGLE = 0;
	CLRF        _ROTATION_ANGLE+0 
	CLRF        _ROTATION_ANGLE+1 
;Main 6.0V.c,193 :: 		if(isPathClear() == 0) {    // if not clear
	CALL        _isPathClear+0, 0
	MOVLW       0
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesWorking972
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesWorking972:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesWorking725
;Main 6.0V.c,195 :: 		for(counter = 1; counter <= 6; counter++) {
	MOVLW       1
	MOVWF       _counter+0 
	MOVLW       0
	MOVWF       _counter+1 
L_goThroughObstaclesWorking726:
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesWorking973
	MOVF        _counter+0, 0 
	SUBLW       6
L__goThroughObstaclesWorking973:
	BTFSS       STATUS+0, 0 
	GOTO        L_goThroughObstaclesWorking727
;Main 6.0V.c,197 :: 		if(counter % 2 == 0) {
	MOVLW       2
	MOVWF       R4 
	MOVLW       0
	MOVWF       R5 
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesWorking974
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesWorking974:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesWorking729
;Main 6.0V.c,198 :: 		odd = -1;
	MOVLW       255
	MOVWF       _odd+0 
	MOVLW       255
	MOVWF       _odd+1 
;Main 6.0V.c,199 :: 		} else {
	GOTO        L_goThroughObstaclesWorking730
L_goThroughObstaclesWorking729:
;Main 6.0V.c,200 :: 		odd = 1;
	MOVLW       1
	MOVWF       _odd+0 
	MOVLW       0
	MOVWF       _odd+1 
...
;Main 6.0V.c,203 :: 		degree = odd * counter * 30;
	MOVF        _odd+0, 0 
	MOVWF       R0 
	MOVF        _odd+1, 0 
	MOVWF       R1 
	...
	MOVF        R1, 0 
	MOVWF       _degree+1 
;Main 6.0V.c,204 :: 		rotateByDegree(degree);
	MOVF        R0, 0 
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVF        R1, 0 
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,205 :: 		ROTATION_ANGLE += degree;
	MOVF        _degree+0, 0 
	ADDWF       _ROTATION_ANGLE+0, 1 
	MOVF        _degree+1, 0 
	ADDWFC      _ROTATION_ANGLE+1, 1 
;Main 6.0V.c,206 :: 		if(isPathClear() == 0) {
	CALL        _isPathClear+0, 0
	MOVLW       0
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesWorking975
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesWorking975:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesWorking731
;Main 6.0V.c,207 :: 		continue;
	GOTO        L_goThroughObstaclesWorking728
;Main 6.0V.c,208 :: 		} else {
L_goThroughObstaclesWorking731:
;Main 6.0V.c,209 :: 		break;
	GOTO        L_goThroughObstaclesWorking727
;Main 6.0V.c,212 :: 		}
...
L_goThroughObstaclesWorking733:
	DECFSZ      R13, 1, 0
	BRA         L_goThroughObstaclesWorking733
	DECFSZ      R12, 1, 0
	BRA         L_goThroughObstaclesWorking733
	NOP
;Main 6.0V.c,219 :: 		if(isAllWhite()) {
	CALL        _isAllWhite+0, 0
	MOVF        R0, 0 
	IORWF       R1, 0 
	BTFSC       STATUS+0, 2 
	GOTO        L_goThroughObstaclesWorking734
;Main 6.0V.c,221 :: 		if(abs(DIRECTION) >= 90) {
	MOVF        _DIRECTION+0, 0 
	MOVWF       FARG_abs_a+0 
	MOVF        _DIRECTION+1, 0 
	MOVWF       FARG_abs_a+1 
	...
	SUBWF       R2, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesWorking976
	MOVLW       90
	SUBWF       R0, 0 
L__goThroughObstaclesWorking976:
	BTFSS       STATUS+0, 0 
	GOTO        L_goThroughObstaclesWorking735
;Main 6.0V.c,222 :: 		sendText("Wrong Direction !!!");
	MOVLW       ?lstr40_Main_326.0V+0
	MOVWF       FARG_sendText_aText+0 
	MOVLW       hi_addr(?lstr40_Main_326.0V+0)
	MOVWF       FARG_sendText_aText+1 
	CALL        _sendText+0, 0
;Main 6.0V.c,223 :: 		rotateByDegree(90);
	MOVLW       90
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       0
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,224 :: 		rotateByDegree(90);
	MOVLW       90
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       0
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,225 :: 		DIRECTION = 0;
	CLRF        _DIRECTION+0 
	CLRF        _DIRECTION+1 
;Main 6.0V.c,227 :: 		while(!isAllBlack()){
L_goThroughObstaclesWorking736:
	CALL        _isAllBlack+0, 0
	MOVF        R0, 0 
	IORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesWorking737
;Main 6.0V.c,228 :: 		moveStraightSlow();
	CALL        _moveStraightSlow+0, 0
;Main 6.0V.c,229 :: 		}
	GOTO        L_goThroughObstaclesWorking736
L_goThroughObstaclesWorking737:
;Main 6.0V.c,230 :: 		} else {
	GOTO        L_goThroughObstaclesWorking738
L_goThroughObstaclesWorking735:
;Main 6.0V.c,231 :: 		LEVEL2_STATE = COMPLETED;
	MOVLW       2
	MOVWF       _LEVEL2_STATE+0 
	MOVLW       0
	MOVWF       _LEVEL2_STATE+1 
...
;Main 6.0V.c,237 :: 		void goThroughObstacles(){
;Main 6.0V.c,238 :: 		if(getDistanceSonar2('M') < 10 ){
	MOVLW       77
	MOVWF       FARG_getDistanceSonar2_Sensor+0 
	CALL        _getDistanceSonar2+0, 0
	MOVLW       10
	SUBWF       R0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_goThroughObstacles739
;Main 6.0V.c,239 :: 		stop();
	CALL        _stop+0, 0
;Main 6.0V.c,240 :: 		if(DIRECTION<0){
	MOVLW       128
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstacles977
	MOVLW       0
	SUBWF       _DIRECTION+0, 0 
L__goThroughObstacles977:
	BTFSC       STATUS+0, 0 
	GOTO        L_goThroughObstacles740
;Main 6.0V.c,241 :: 		rotateByDegree(45);
	MOVLW       45
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       0
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,242 :: 		DIRECTION +=45;
	MOVLW       45
	ADDWF       _DIRECTION+0, 1 
	MOVLW       0
	ADDWFC      _DIRECTION+1, 1 
;Main 6.0V.c,243 :: 		if(getDistanceSonar2('M') < 10 ){
	MOVLW       77
	MOVWF       FARG_getDistanceSonar2_Sensor+0 
	CALL        _getDistanceSonar2+0, 0
	MOVLW       10
	SUBWF       R0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_goThroughObstacles741
;Main 6.0V.c,244 :: 		rotateByDegree(-45);
	MOVLW       211
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       255
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,245 :: 		rotateByDegree(-45);
	MOVLW       211
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       255
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,246 :: 		DIRECTION -=90;
	MOVLW       90
...
;Main 6.0V.c,248 :: 		}
	GOTO        L_goThroughObstacles742
L_goThroughObstacles740:
;Main 6.0V.c,250 :: 		rotateByDegree(-45);
	MOVLW       211
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       255
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,251 :: 		DIRECTION -=45;
	MOVLW       45
	SUBWF       _DIRECTION+0, 1 
	MOVLW       0
	SUBWFB      _DIRECTION+1, 1 
;Main 6.0V.c,252 :: 		if(getDistanceSonar2('M') < 10 ){
	MOVLW       77
	MOVWF       FARG_getDistanceSonar2_Sensor+0 
	CALL        _getDistanceSonar2+0, 0
	MOVLW       10
	SUBWF       R0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_goThroughObstacles743
;Main 6.0V.c,253 :: 		rotateByDegree(45);
	MOVLW       45
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       0
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,254 :: 		rotateByDegree(45);
	MOVLW       45
	MOVWF       FARG_rotateByDegree_degree+0 
	MOVLW       0
	MOVWF       FARG_rotateByDegree_degree+1 
	CALL        _rotateByDegree+0, 0
;Main 6.0V.c,255 :: 		DIRECTION +=90;
	MOVLW       90
	ADDWF       _DIRECTION+0, 1 
	MOVLW       0
	ADDWFC      _DIRECTION+1, 1 
...
;Main 6.0V.c,258 :: 		}
	GOTO        L_goThroughObstacles744
L_goThroughObstacles739:
;Main 6.0V.c,260 :: 		moveStraightFast();
	CALL        _moveStraightFast+0, 0
;Main 6.0V.c,261 :: 		}
L_goThroughObstacles744:
;Main 6.0V.c,262 :: 		delay_ms(10);
	MOVLW       65
	MOVWF       R12, 0
	MOVLW       238
	MOVWF       R13, 0
...
;Main 6.0V.c,267 :: 		if(isPathClear() == 0) {
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay978
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesJay978:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay746
...
;Main 6.0V.c,270 :: 		if(isPathClear() == 0) {
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay979
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesJay979:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay747
...
;Main 6.0V.c,273 :: 		if(isPathClear() == 0) {
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay980
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesJay980:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay748
...
;Main 6.0V.c,276 :: 		if(isPathClear() == 0) {
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay981
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesJay981:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay749
...
;Main 6.0V.c,280 :: 		if(isPathClear() == 0) {
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay982
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesJay982:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay750
...
;Main 6.0V.c,284 :: 		if(isPathClear() == 0) {
	...
	XORWF       R1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay983
	MOVLW       0
	XORWF       R0, 0 
L__goThroughObstaclesJay983:
	BTFSS       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay751
...
L_goThroughObstaclesJay752:
	DECFSZ      R13, 1, 0
	BRA         L_goThroughObstaclesJay752
	DECFSZ      R12, 1, 0
	BRA         L_goThroughObstaclesJay752
	NOP
;Main 6.0V.c,298 :: 		if(isAllWhite()) {
	...
	IORWF       R1, 0 
	BTFSC       STATUS+0, 2 
	GOTO        L_goThroughObstaclesJay753
;Main 6.0V.c,300 :: 		if(abs(DIRECTION) >= 90) {
	...
	SUBWF       R2, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__goThroughObstaclesJay984
	MOVLW       90
	SUBWF       R0, 0 
L__goThroughObstaclesJay984:
	BTFSS       STATUS+0, 0 
	GOTO        L_goThroughObstaclesJay754
...
;Main 6.0V.c,307 :: 		}
	GOTO        L_goThroughObstaclesJay755
...
;Main 6.0V.c,325 :: 		void checkSonar(char Sensor){
;Main 6.0V.c,326 :: 		if(Sensor == 'L'){
	MOVF        FARG_checkSonar_Sensor+0, 0 
	XORLW       76
	BTFSS       STATUS+0, 2 
	GOTO        L_checkSonar760
;Main 6.0V.c,327 :: 		distanceSonar = getDistanceSonar2('L');
	MOVLW       76
	MOVWF       FARG_getDistanceSonar2_Sensor+0 
	CALL        _getDistanceSonar2+0, 0
	MOVF        R0, 0 
	MOVWF       _distanceSonar+0 
;Main 6.0V.c,328 :: 		if(distanceSonar < 10)
	MOVLW       10
	SUBWF       R0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_checkSonar761
;Main 6.0V.c,329 :: 		sendText("Obstacle" );
...
L_checkSonar761:
;Main 6.0V.c,330 :: 		}
	GOTO        L_checkSonar762
L_checkSonar760:
;Main 6.0V.c,331 :: 		else if(Sensor == 'M'){
	MOVF        FARG_checkSonar_Sensor+0, 0 
	XORLW       77
	BTFSS       STATUS+0, 2 
	GOTO        L_checkSonar763
;Main 6.0V.c,332 :: 		distanceSonar = getDistanceSonar2('M');
	MOVLW       77
	MOVWF       FARG_getDistanceSonar2_Sensor+0 
	CALL        _getDistanceSonar2+0, 0
	MOVF        R0, 0 
	MOVWF       _distanceSonar+0 
;Main 6.0V.c,333 :: 		if(distanceSonar < 10)
	MOVLW       10
	SUBWF       R0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_checkSonar764
;Main 6.0V.c,334 :: 		sendText("Obstacle" );
...
L_checkSonar764:
;Main 6.0V.c,335 :: 		}
	GOTO        L_checkSonar765
L_checkSonar763:
;Main 6.0V.c,336 :: 		else if(Sensor == 'R'){
	MOVF        FARG_checkSonar_Sensor+0, 0 
	XORLW       82
	BTFSS       STATUS+0, 2 
	GOTO        L_checkSonar766
;Main 6.0V.c,337 :: 		distanceSonar = getDistanceSonar2('R');
	MOVLW       82
	MOVWF       FARG_getDistanceSonar2_Sensor+0 
	CALL        _getDistanceSonar2+0, 0
	MOVF        R0, 0 
	MOVWF       _distanceSonar+0 
;Main 6.0V.c,338 :: 		if(distanceSonar < 10)
	MOVLW       10
	SUBWF       R0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_checkSonar767
;Main 6.0V.c,339 :: 		sendText("Obstacle" );
	MOVLW       ?lstr45_Main_326.0V+0
	MOVWF       FARG_sendText_aText+0 
	MOVLW       hi_addr(?lstr45_Main_326.0V+0)
	MOVWF       FARG_sendText_aText+1 
	CALL        _sendText+0, 0
L_checkSonar767:
;Main 6.0V.c,340 :: 		}
